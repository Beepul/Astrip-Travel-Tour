...
import { tourcat, blogcat, destcat } from '../data/category';
...
const Header = () => {
	...
	const handleTravel = (e) => {
		...
		navigate('/findfilter', { state: { filteredTour: filteredTour, type: selectedTravel } });
	};
						...
						<ul className=" menu d-none d-lg-flex justify-content-end justify-content-xl-center gap-4 align-items-center">
							...
							<li>
								<LinkContainer to={'/destination'}>
									<NavLink  className="d-flex gap-2 align-items-center">Destination</NavLink>
								</LinkContainer>
							</li>
							<li>
								<LinkContainer to={'/blogs'}>
									<NavLink className="d-flex gap-2 align-items-center">Blog</NavLink>
								</LinkContainer>
							</li>
							<li>
